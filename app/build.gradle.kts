...
android {
    ...
    compileOptions {
        ...
        // Backport java.time (and other Java 8+ APIs) to all minSdk-29 devices. Without this,
        // API 34+ additions like LocalDate.ofInstant throw NoSuchMethodError on older devices.
